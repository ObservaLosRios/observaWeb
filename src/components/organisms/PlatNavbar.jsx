...
import ToggleDarkMode from "../../components/atoms/ToggleDarkMode/ToggleDarkMode";
...
const PlatNavbar = () => {
  ...
  return (
    <nav className="bg-white border-b border-gray-200 dark:border-b-0 dark:bg-plataformaBase">
      <div className="flex flex-wrap items-center justify-between max-w-screen-xl mx-auto p-4">
        ...
        >
          <img
            src={isDark ? logoNavbarBlanco : logoNavbarNegro}
            className="h-8"
            alt="Observa Logo"
          />
        </Link>
          ...
          <ul className="flex flex-col mt-4 font-medium md:flex-row md:mt-0 md:space-x-8 rtl:space-x-reverse">
            ...
            <li>
              ...
              <div
                ...
                className="absolute z-10 grid hidden w-auto grid-cols-1 text-sm bg-white border border-gray-100 rounded-lg shadow-md dark:border-gray-700 md:grid-cols-1 dark:bg-gray-700"
              >
                  ...
                  >
                    ...
                    <li>
                      <Link
                        ...
                        className="flex items-center text-gray-500 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-500 group"
                      >
                        <span className="sr-only">Indicadores Sintéticos</span>
                        Indicadores Sintéticos
                      </Link>
                    </li>
                    <li>
                      <Link
                        to="indicadoreslineamiento"
                        className="flex items-center text-gray-500 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-500 group"
                      >
                        <span className="sr-only">Indicadores por Meta</span>
                        Indicadores por Lineamiento Estratégico
                      </Link>
                    </li>
                    <li>
                      <Link
                        to="indicadoresiniciativa"
                        className="flex items-center text-gray-500 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-500 group"
                      >
                    ...
                    <li>
                      <Link
                        to="indicadoresgeorreferenciados"
                        className="flex items-center text-gray-500 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-500 group"
                      >
                        <span className="sr-only">
